...
export const services: Service[] = [
  ...
  },
  {
    ...
    slug: "hr-people-ops",
    shortDescription: "Streamline hiring, onboarding, payroll, and compliance workflows.",
    icon: Users,
    roles: [
      ...
      { name: "Onboarding Coordinator", slug: "onboarding-coordinator", shortDescription: "New hire logistics, documentation, and first-week experience." },
