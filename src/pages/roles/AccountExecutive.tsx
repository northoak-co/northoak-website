...
const faqs = [
  { question: "How quickly can I hire a Account Executive?", answer: "NorthOak matches you with a vetted Account Executive in 5 business days." },
  { question: "What does a Account Executive cost with NorthOak?", answer: "Plans start at $2,000/mo, all-inclusive. No recruiting fees or benefits overhead." },
...
const Page = () => (
  <RolePageLayout
    ...
    description="Dedicated Account Executive specialists embedded in your team, working your hours."
    benefits={[
    ...
    tldr="NorthOak Account Executives are dedicated to your account, embedded in your tools, and working your hours. Starts at $2,000/mo. Guaranteed service."
