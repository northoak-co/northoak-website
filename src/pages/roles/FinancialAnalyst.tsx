...
export const meta = () => [
  ...pageMeta({ title: "Hire a Financial Analyst - NorthOak", description: "Dedicated Financial Analyst specialists for high-growth teams. Starts at $2,000/mo." }),
];

const faqs = [
  { question: "How quickly can I hire a Financial Analyst?", answer: "NorthOak matches you with a vetted Financial Analyst in 5 business days." },
  { question: "What does a Financial Analyst cost with NorthOak?", answer: "Plans start at $2,000/mo, all-inclusive. No recruiting fees or benefits overhead." },
...
const Page = () => (
  <RolePageLayout
    ...
    tldr="NorthOak Financial Analysts are dedicated to your account, embedded in your tools, and working your hours. Starts at $2,000/mo. Guaranteed service."
