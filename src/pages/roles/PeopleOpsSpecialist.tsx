...
export const meta = () => [
  ...pageMeta({ title: "Hire a People Operations Specialist - NorthOak", description: "Dedicated People Operations Specialist specialists for high-growth teams. Starts at $2,000/mo." }),
];

const faqs = [
  { question: "How quickly can I hire a People Operations Specialist?", answer: "NorthOak matches you with a vetted People Operations Specialist in 5 business days." },
  { question: "What does a People Operations Specialist cost with NorthOak?", answer: "Plans start at $2,000/mo, all-inclusive. No recruiting fees or benefits overhead." },
...
const Page = () => (
  <RolePageLayout
    icon={Users}
    subtitle="HR & People Ops"
    title="People Operations Specialist"
    image={hrAdminImg}
    description="Dedicated People Operations Specialist specialists embedded in your team, working your hours."
    benefits={[
      "Dedicated to you",
      "Fast onboarding",
    ...
    tldr="NorthOak People Operations Specialists are dedicated to your account, embedded in your tools, and working your hours. Starts at $2,000/mo. Guaranteed service."
