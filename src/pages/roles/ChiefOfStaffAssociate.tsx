...
import executiveAssistantImg from "@/assets/characters/executive-assistant.png";

export const meta = () => [
  ...pageMeta({ title: "Hire a Chief of Staff (Associate) - NorthOak", description: "Dedicated Chief of Staff (Associate) specialists for high-growth teams. Starts at $2,000/mo." }),
];

const faqs = [
  { question: "How quickly can I hire a Chief of Staff (Associate)?", answer: "NorthOak matches you with a vetted Chief of Staff (Associate) in 5 business days." },
  { question: "What does a Chief of Staff (Associate) cost with NorthOak?", answer: "Plans start at $2,000/mo, all-inclusive. No recruiting fees or benefits overhead." },
...
const Page = () => (
  <RolePageLayout
    ...
    image={executiveAssistantImg}
    description="Dedicated Chief of Staff (Associate) specialists embedded in your team, working your hours."
    benefits={[
      "Dedicated to you",
      "Fast onboarding",
    ...
    tldr="NorthOak Chief of Staff (Associate)s are dedicated to your account, embedded in your tools, and working your hours. Starts at $2,000/mo. Guaranteed service."
