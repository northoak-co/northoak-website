...
export const meta = () => [
  ...pageMeta({ title: "Hire a Live Chat Specialist - NorthOak", description: "Dedicated Live Chat Specialist specialists for high-growth teams. Starts at $2,000/mo." }),
];

const faqs = [
  { question: "How quickly can I hire a Live Chat Specialist?", answer: "NorthOak matches you with a vetted Live Chat Specialist in 5 business days." },
  { question: "What does a Live Chat Specialist cost with NorthOak?", answer: "Plans start at $2,000/mo, all-inclusive. No recruiting fees or benefits overhead." },
...
const Page = () => (
  <RolePageLayout
    ...
    description="Dedicated Live Chat Specialist specialists embedded in your team, working your hours."
    benefits={[
    ...
    tldr="NorthOak Live Chat Specialists are dedicated to your account, embedded in your tools, and working your hours. Starts at $2,000/mo. Guaranteed service."
