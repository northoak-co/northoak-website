...
const faqs = [
  { question: "How quickly can I hire a Order Processing Specialist?", answer: "NorthOak matches you with a vetted Order Processing Specialist in 5 business days." },
  { question: "What does a Order Processing Specialist cost with NorthOak?", answer: "Plans start at $2,000/mo, all-inclusive. No recruiting fees or benefits overhead." },
...
const Page = () => (
  <RolePageLayout
    ...
    tldr="NorthOak Order Processing Specialists are dedicated to your account, embedded in your tools, and working your hours. Starts at $2,000/mo. Guaranteed service."
