...
const faqs = [
  { question: "How quickly can I hire a Document Management Specialist?", answer: "NorthOak matches you with a vetted Document Management Specialist in 5 business days." },
  { question: "What does a Document Management Specialist cost with NorthOak?", answer: "Plans start at $2,000/mo, all-inclusive. No recruiting fees or benefits overhead." },
...
const Page = () => (
  <RolePageLayout
    ...
    description="Dedicated Document Management Specialist specialists embedded in your team, working your hours."
    benefits={[
    ...
    tldr="NorthOak Document Management Specialists are dedicated to your account, embedded in your tools, and working your hours. Starts at $2,000/mo. Guaranteed service."
