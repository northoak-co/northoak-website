...
export const meta = () => [
  ...pageMeta({ title: "Hire a SEO Specialist - NorthOak", description: "Dedicated SEO Specialist specialists for high-growth teams. Starts at $2,000/mo." }),
];

const faqs = [
  { question: "How quickly can I hire a SEO Specialist?", answer: "NorthOak matches you with a vetted SEO Specialist in 5 business days." },
  { question: "What does a SEO Specialist cost with NorthOak?", answer: "Plans start at $2,000/mo, all-inclusive. No recruiting fees or benefits overhead." },
...
const Page = () => (
  <RolePageLayout
    ...
    description="Dedicated SEO Specialist specialists embedded in your team, working your hours."
    benefits={[
      "Dedicated to you",
      "Fast onboarding",
    ...
    tldr="NorthOak SEO Specialists are dedicated to your account, embedded in your tools, and working your hours. Starts at $2,000/mo. Guaranteed service."
