...
const GetStarted = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col overflow-x-hidden">
      <main className="flex-1 flex flex-col px-3 md:px-4 pt-3 pb-3 md:pb-4">
        <motion.div
          ref={containerRef}
          ...
          className="flex-1 relative rounded-3xl md:rounded-[2.5rem] border border-sage/25 overflow-hidden flex flex-col"
          style={{
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <motion.div
              ...
              style={{ background: "hsl(102 44% 51% / 0.25)", x: particle1X, y: particle1Y }}
            />
            <motion.div
              className="absolute bottom-1/3 left-1/3 w-40 h-40 rounded-full blur-2xl"
              style={{ background: "hsl(102 44% 51% / 0.19)", x: particle2X, y: particle2Y }}
            />
          </div>

          <div className="flex-1 flex flex-col relative z-10 px-6 md:px-12 lg:px-20 pt-8 md:pt-10 pb-16 md:pb-24">
            <MultiStepIntake />
          </div>
        </motion.div>
      </main>
